...
func main() {
	...
	endpoint := "http://1101251076097726.mqrest.cn-shenzhen.aliyuncs.com"
	// AccessKey 阿里云身份验证，在阿里云服务器管理控制台创建
	accessKey := "LTAIqbpJ2AxakkoX"
	// SecretKey 阿里云身份验证，在阿里云服务器管理控制台创建
	secretKey := "GRRjcYsnhV7BBeBPOIvNGDayn3p4lB"
	// 所属的 Topic
	topic := "img_callback"
	// Topic所属实例ID，默认实例为空
	instanceId := "MQ_INST_1101251076097726_Bafb15s8"
	// 您在控制台创建的 Consumer ID(Group ID)
	groupId := "GID-WEBOX-HTTP"
